...
use Hyperf\Zby\Office\Excel\PhpOffice;
use Hyperf\Zby\Office\Excel\XlsWriter;

class ZbyCollection extends Collection
{
    /**
     * 系统菜单转前端路由树
     * @return array
     ...
     * @throws \Psr\Container\NotFoundExceptionInterface
     */
    public function import(string $dto, ZbyModel $model, ?\Closure $closure = null): bool
    {
        $excelDrive = 'auto';
        if ($excelDrive === 'auto') {
            $excel = extension_loaded('xlswriter') ? new XlsWriter($dto) : new PhpOffice($dto);
